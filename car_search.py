...
def search_in_databases():
    databases = ['gbdd_rus']
    criteria = ['Name', 'Phone','Two_name','car_number']
...
def run_free_code():
    subprocess.Popen(["python", "car_search.py"])
...
label = ttk.Label(root, text="Введите номер телефона, имя, фамилия, номер автомобиля:", foreground="red", background="black")
label.pack(pady=10)
